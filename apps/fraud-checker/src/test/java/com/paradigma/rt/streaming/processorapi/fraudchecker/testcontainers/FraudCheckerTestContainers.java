package com.paradigma.rt.streaming.processorapi.fraudchecker.testcontainers;
...
public class FraudCheckerTestContainers {
    ...
    public void tearDown() {
        ...
        consumer.stop();
        consumer = null;
//        DeleteTopicsResult deleteTopicsResult = client.deleteTopics(Arrays.asList(fraudCheckerConfig.getMovementsTopic(), fraudCheckerConfig.getFraudTopic()));
//        while (!deleteTopicsResult.all().isDone()) {
//            log.debug("Waiting for topics are deleted.....");
//        }
    }
